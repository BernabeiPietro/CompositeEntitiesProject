...
class ClientRestTest {
	...
	void testFindEntityByFilter() {
		assertThat(client.findEntityByFilter(Map.of("type", "ManufacturingMachine"),
	...
	void testPostEntityMap() {
		assertThat(
				client.postEntity(new HashMap<>(Map.of("id", "urn:ngsi-ld:Machine:9166c528-9c98-4579-a5d3-8068aea5d7k0",
						"machineModel", "urn:ngsi-ld:MachineModel:00b42701-43e1-482d-aa7a-e2956cfd65k9", "description",
						"Auger - Trivella", "type", "ManufactoringMachine"))).getStatus())
				.isEqualTo(201);
	}
	...
	void testPostEntityList() {
		assertThat(client.postEntity(
				List.of(new HashMap<>(Map.of("id", "urn:ngsi-ld:Machine:9166c528-9c98-4579-a5d3-8068aea5d7k0",
						"machineModel", "urn:ngsi-ld:MachineModel:00b42701-43e1-482d-aa7a-e2956cfd65k9", "description",
