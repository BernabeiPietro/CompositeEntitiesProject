...
public interface ClientRest {
	...
	// @ClientHeaderParam(name = "Content-Type", value =
	// "${rest-client.contenttype}")
	public List<HashMap<String, Object>> findEntityByFilter(@RestQuery Map<String, String> filter);
	...
	public Response postSubscription(HashMap<String, Object> operation);
